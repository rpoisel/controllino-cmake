...
set(CMAKE_C_FLAGS "-g -Os -w -std=gnu11 -ffunction-sections -fdata-sections -mmcu=atmega2560" CACHE STRING "")

set(CMAKE_CXX_FLAGS "-g -Os -w -std=gnu++11 -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics -mmcu=atmega2560" CACHE STRING "")

set(CMAKE_EXE_LINKER_FLAGS "-w -Os -Wl,--gc-sections,--relax -mmcu=atmega2560")
