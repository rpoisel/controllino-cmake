...
set(ARDUINO_ARCH ARDUINO_AVR_NANO)
...
set(CMAKE_C_FLAGS "-g -Os -w -std=gnu11 -ffunction-sections -fdata-sections -mmcu=atmega328p" CACHE STRING "")

set(CMAKE_CXX_FLAGS "-g -Os -w -std=gnu++11 -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics -mmcu=atmega328p" CACHE STRING "")

set(CMAKE_EXE_LINKER_FLAGS "-w -Os -Wl,--gc-sections -mmcu=atmega328p")
